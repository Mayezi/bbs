package com.mayezi.model.notification.controller;
...
public class NotificationController extends BaseController {
    ...
    public String list(Integer p, Model model) {
        model.addAttribute("page", notificationService.findByTargetUserAndRread(p == null ? 1 : p, siteConfig.getPageSize(), getUser(), null));
        //将未读消息置为已读
        notificationService.updateByRread(getUser());
